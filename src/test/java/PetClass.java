...
public class PetClass {
    ...
    public void PetClass () {
        ...
        Response response = httpRequest.get("/pet/12");
        JsonPath jsonPathEvaluator = response.jsonPath();
        String name = jsonPathEvaluator.get("name");
        int id = jsonPathEvaluator.get("id");
        LinkedHashMap<String,String> categoryName = jsonPathEvaluator.get("category");
        String categoryNaame = jsonPathEvaluator.get("category.age");
