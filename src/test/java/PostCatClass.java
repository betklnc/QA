...
public class PostCatClass {
    ...
    public void PostCatClass() {
      ...
      // requestParams.put("name", "cats");
      // requestParams.put("category.name", "cats");
      // requestParams.put("category.id", 1);
      // requestParams.put("photoUrls", "string");
      // requestParams.put("tags.id", 0);
      // requestParams.put("tags.name", "string");
      // requestParams.put("status", "available");
        ...
        //List<Object> objects = jsonPathEvaluator.get("Pet");
